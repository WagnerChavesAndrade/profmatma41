...
Seja $X_1\;,X_2\, ,...,\,X_n$ uma sequência de variáveis aleatórias independentes e identicamente distribuídas com média $\mu$ e variância finita $\sigma^2$. Seja $S_n\;=\;X_1 + X_2 + ... + X_n$ a soma das _n_ variáveis aleatórias. Então conforme $n\longrightarrow \infty$, a soma normalizada $Z_n$ (ou seja, a média padronizada) converge em distribuição para uma distribuição normal padrão $N(0,1)$:

$$Z_n\;=\;\frac{S_n-n\mu}{\sigma \sqrt{n}}\longrightarrow^{d}\;N(0,1)\; ,n\longrightarrow \infty.$$