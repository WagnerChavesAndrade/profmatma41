...
Por ser um conjunto par, identificamos os dois números do centro que irão dividir igualmente o conjunto. Nesse caso, temos $\frac{4+4}{2}=4$. Em seguida, tiramos a média aritmética:
